...
ui  <- navbarPage(
  ...
  tabPanel("Frech Takes",
           ...
           h5(""),
           hr(),
           tags$li("FVOA now has two postseason fates decided - in every simulated season now David is in and Commish is out"),
           tags$li("David's team is so dominant that he's over 16.5 points better than an average team, which is more than double 2nd strongest"),
           tags$li("PFinn and Josh are both in top-4 despite having 4th and 3rd weakest teams respectively"),
           tags$li("Diaz is the only team that has a real chance of taking 1st place from David, though even that is only in 6% of simulations, which is why FVOA thinks their matchup this week is on par with the Chiefs-Bills game we got recently"),
           tags$li("Justin's has a 3-in-4 chance of making the playoffs despite being in 5th because he's only a game behind 3 teams ahead of him and FVOA likes his schedule down the stretch"),
           tags$li("As of now 3 of the 4 spots seem to have a strong contender, but that last spot could go to any of 6 teams as we get to the final third of the season"),
           tags$li(HTML("<u><strong>Commish Corner</strong></u> - still fun to try and ruin some team's playoff chances")),
           hr(),
