...
ui  <- navbarPage(
  ...
  tabPanel("Frech Takes",
           ...
           h5(""),
           hr(),
           tags$li("Six strongest teams remain in the top 6, but I'm sure there will still be chaos to come"),
           tags$li("Looks like Eric's team is the reigning juggernaut wtih David right on his heels"),
           tags$li("Though it's great that my own model doesn't trust my undefeated team and only has me with 3rd best odds of making playoffs"),
           tags$li("But congrats to German for sneaking into the underrated club...time to keep an eye on out where his team goes"),
           tags$li("Poor PFinn can't seem to catch a win, even though he's stronger than 2 other taems"),
           tags$li(HTML("<u><strong>Commish Corner</strong></u> - things ain't looking good here for our boy")),
           hr(),
