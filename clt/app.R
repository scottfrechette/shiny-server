...
ui  <- navbarPage(
  ...
  tabPanel("Frech Takes",
           ...
           h5(""),
           hr(),
           tags$li("The last week was pure chaos and has sent FVOA reeling across the board"),
           tags$li("David has given up his crown to Eric, who now has the strongest team and 2nd best chance to make playoffs"),
           tags$li("Two teams are now flagged as overrated - Diaz is somehow still in 4th despite having the 3rd weakest squad, and German is in 6th with 2nd weakest"),
           tags$li("Josh is underrated with 5th strongest team in 7th place, including being a TD-favorite over an average team"),
           tags$li("Congrats to PFinn for his monster win that gives him an outside shot at playoffs again and he's now moved up to the 6th strongest team even if he's still sitting in last place with 1 win"),
           tags$li("Barrett's first huge game didn't get him a W but it did get him moved up to only 4th-weakest team"),
           tags$li("Bobby has the weakest team, but somehow would still be favored over an average team, which is why he also has an outside chance of making playoffs still. That or FVOA is broken."),
