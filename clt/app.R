...
ui  <- navbarPage(
  ...
  tabPanel("Frech Takes",
           ...
           h5(""),
           hr(),
           tags$li("Like, I don't even now anymore dudes. What is going on with this season?"),
           tags$li("I did some historical digging and through 9 weeks this is the worst the league has done collectively since 2017. In fact every year has gone down a little bit more in almost a straight line. I blame defensive players."),
           tags$li("After 9 weeks the teams ranked 4-6 in FVOA are in 8th, 10th, and 9th place respectively. For fuck's sake German's 8th place team has almost even odds to make playoffs."),
           tags$li("FVOA is starting to suspect Bobby's team is running out of steam given it wouldn't even be giving a half point against neutral team, but that 6-3 record is still doing a lot to keep playoff hopes alive"),
           tags$li("I'm not really sure I get why Diaz's team has lowest chances to make playoffs? Currently in 6th place, not the worst FVOA, and remaining schedule is average difficulty. Looking at the model output the main thing I can see is the line is trending down pretty steeply but I'm shocked it has it affecting the remaining season that much."),
           tags$li("Frankly, the less I have to talk about PFinn's continued streak of failing up the better. His team is averaging <100 points a week and sitting in 3rd. Overrated indeed. Yet will still somehow walk away with the trophy."),
           tags$li(HTML("<u><strong>Commish Corner</strong></u> - last week's upset put him back in 7th though FVOA still has him last, but at least he somehow squeaked past Diaz to not have worst playoff odds at this point")),
           hr(),
