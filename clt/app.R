...
ui  <- navbarPage(
  ...
  tabPanel("Frech Takes",
           ...
           h5(""),
           hr(),
           tags$li("With 2 weeks to go we have our first two teams to guarantee a playoff run. David continued his seasonal dominance with another high score and Diaz has won 4 in a row to secure their spots."),
           tags$li("PFinn has a 90% chance of making the playoffs as well"),
           tags$li("It's interesting that Diaz and PFinn are 6th and 5th strongest teams respectively, but have secured or nearly secured their spots because they have the two easiest schedules in the league"),
           tags$li("Playoff simulator has a lot of seasons on the line this week given we have 5 teams tied for 4th best record"),
           tags$li("FVOA thinks Eric or Chris have best chance of snagging the final spot given they are 2nd and 3rd strongest teams right now"),
           tags$li("I'm honestly shocked FVOA still thinks Bobby's 5-8 team has a 2% chance of making it, but with fantasy there's always chance for some shenanigans to let the 4th strongest team rise from 9th place and squeak through"),
           tags$li(HTML("<u><strong>Commish Corner</strong></u> - not much chaos to spread in a meaningless game against a team that is already guaranteed a spot")),
           hr(),
