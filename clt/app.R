...
ui  <- navbarPage(
  ...
  tabPanel("Frech Takes",
           ...
           h5(""),
           hr(),
           tags$li("After 12 weeks we have officially lost 3 teams - RIP to brothers-in-cleats Bobby, Commish, and PFinn"),
           tags$li("My team is locked in, Eric is all but assured to make it, and David would have to have a big collapse to drop out at this point"),
           tags$li("This realistically leaves us with 4 teams fighting over that last spot"),
           tags$li("Justin has the best chance, which makes sense when he's also the 4th best team"),
           tags$li("Josh is next with the same 6-6 record, and again tracks when FVOA says he's the 5th best team"),
           tags$li("Where it gets fun is Diaz is next despite being 7-5 because he's only the 7th best team and FVOA considers his team overrated"),
           tags$li("Finally German is still sitting with a 1-in-20 chance and his season is entirely hinging on this week's matchup. In unrelated news my Venmo is @Scott-Frechette."),
           tags$li("I'd be remiss if I didn't pour one out for my homey PFinn who has the 6th best team but due to some really terrible schedule luck is somehow in last place. His team wasn't great, but it's the 6th best in the league and he deserves to be sitting with an outside chance at a run to the playoffs."),
