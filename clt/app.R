...
ui  <- navbarPage(
  ...
  tabPanel("Frech Takes",
           ...
           h5(""),
           hr(),
           tags$li("We've just crossed the halfway mark and this season is still pretty up in the air"),
           tags$li("It's looking like this season is going to come down to David or PFinn, though Diaz is looking right over their shoulder"),
           tags$li("Josh and I are the only other teams over .500 now, but FVOA really isn't liking what it sees these days"),
           tags$li("Justin has really gotten screwed because despite having the 2nd most points and currently 4th strongest team he's sitting in 6th because he has 30 more points allowed than the next highest team. In fact in almost 3 of 4 simulated seasons he's in top-3 with the same scores, which explains why he has by far the hardest schedule according to FVOA."),
           tags$li(HTML("<u><strong>Commish Corner</strong></u> - there's still a chance")),
           hr(),
