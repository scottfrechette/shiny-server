...
ui  <- navbarPage(
  ...
  tabPanel("Frech Takes",
           ...
           h5(""),
           hr(),
           tags$li("After a brief week off PFinn is now the strongest team again, and somehow regained his crown even with a loss"),
           tags$li("I truly think something broke within FVOA because Josh went from being strongest team to 3rd weakest, though in fairness he did score the 2nd lowest points"),
           tags$li("I left over 60 points on my bench, mostly because I was sitting on Bo Nix's historic comeback and the Browns somehow scoring 25"),
           tags$li("Speaking of crazy FVOA swings Chris' team is now the 3rd strongest and he's on a 2-game winning streak after starting 0-5, which is why he's up to 40% chance to make playoffs"),
           tags$li(HTML("<u><strong>Commish Corner</strong></u> - last place in rankings, last place in FVOA, not even a 1% chance of making playoffs...the only solace is my terrible team is 2nd worst and seeing its playoff chances dwindling rapidly even while still somehow being in 5th place")),
           hr(),
