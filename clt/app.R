...
ui  <- navbarPage(
  ...
  tabPanel("Frech Takes",
           ...
           h5(""),
           hr(),
           tags$li("It's a big week for FVOA...after weeks of chaos the top-4 teams are actually the four strongest"),
           tags$li("The only game with any importance this week is a huge matchup between David and Diaz that is essentially a play-in game"),
           tags$li("I looked into why other games have no importance and top 3 teams seem locked in for playoffs and it's because in final week matchups include current 1v3 and 2v4, which seems to minimize the chaos scenarios somewhat and could only affect final seeding"),
           tags$li("With all that said chaos scenarios are only in play if at least one of Diaz, PFinn, or Josh win this week, and none are favored by FVOA"),
           tags$li("Eric has the most to be frustrated with by sitting in last place somehow with 5th strongest team"),
           tags$li(HTML("<u><strong>Commish Corner</strong></u> - well the Cinderella story has come to a close, and Commish is officially out of the playoffs. At least he is not alone as he is joined by German on the journey to sit on bench with Eric's very good bad team.")),
           hr(),
