...
ui  <- navbarPage(
  ...
  tabPanel("Frech Takes",
           ...
           h5(""),
           hr(),
           tags$li("David's team has been so dominant that despite him having lowest score last week and FVOA increasingly putting more weight on recent games as we get deeper into the season he would still be favored by at least a field goal against any team"),
           tags$li("Justin is a game behind Diaz but FVOA really likes what it's seeing and gives him 2nd best chances to make playoffs. That said, David, Justin, and Diaz are top-3 in 30% of simulations despite Diaz being the 6th strongest team."),
           tags$li("Where it starts to get fun is assuming those 3 don't fall off is who takes that 4th spot. PFinn is currently in 4th but has dropped off lately and FVOA sees his roster as 4rd weakest."),
           tags$li("Chris and Bobby are a game back but FVOA likes their recent momentum, especially Chris with the 3rd strongest team"),
           tags$li("The next tier is Josh, Eric, and myself. Josh has as many wins as Justin and PFinn but 3rd weakest team so would need to reverse his trend. Eric has 4th strongest team now but with only 4 wins would need to basically win out and get some luck of those 1-2 games ahead of him. My team is 2nd weakest and at this point I'm just happy FVOA hasn't completely given up on me."),
           tags$li(HTML("<u><strong>Commish Corner</strong></u> - keep doing the lord's work to maximize chaos at least one more week...love to see FVOA finds the quality of our game is a 0")),
           hr(),
