...
ui  <- navbarPage(
  ...
  tabPanel("Frech Takes",
           ...
           h5(""),
           hr(),
           tags$li("Justin's team is starting to pull ahead. He's a TD-favorite over average team, averaging 20 points more than expected each week, has never scored below 120, almost certain to make playoffs at this pace, an average team would only have a 2% chance of doing as well or better as him...so of course I have to play him this week"),
           tags$li("We're seeing our first fraudulent team with David being in 4th but having the 2nd worst team"),
           tags$li("Diaz has a perfectly average team - he's almost perfectly matched to historically average team, right at the average of this season, and is currently 2-2"),
           tags$li("Interesting to see we've had a pretty balanced schedule so far with no teams wildly out of line with other random schedules"),
           tags$li("Simulations for final standings show it's still wide open with almost any outcome reasonable for each team other than pretty confident Justin comes in top-4"),
           tags$li(HTML("<u><strong>Commish Corner</strong></u> - congrats on having the 5th best team despite being in 8th...you have just over a 1 in 3 chance of making playoffs")),
           hr(),
