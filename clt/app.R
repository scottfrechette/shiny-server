...
ui  <- navbarPage(
  ...
  tabPanel("Frech Takes",
           ...
           h5(""),
           hr(),
           tags$li("We're just over halfway into the season and I'm sorry to report we have our first playoff casualty...PFinn no longer has a path to playoffs. At this point the real question is - can he at least win a game before the season ends?"),
           tags$li("The Commish is barely hanging on to an outside chance, with less than 1% chance to make it. One interesting fact is his team has yet to score above 110, which is our historical average. But somehow he could make the playoffs...fantasy is a trip."),
           tags$li("Not only did I take my first L of the season I also took a noticeable dip in chances to make playoff despite still being in 1st. FVOA really doesn't trust my team"),
           tags$li("Josh is the underdog I'd pick if I wanted good odds because FVOA thinks he's better than his record suggests"),
           tags$li("Since week 1 David's team hasn't scored below 124 points...he's approaching being a 2-TD favorite over an average team, which I'm fairly confident is a new level of dominance"),
           tags$li("Justin and German's teams are still trying to decide what they want to be when they grow up. Though German has to stop taking out knees if he wants to make it to the finish line."),
