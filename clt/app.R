...
ui  <- navbarPage(
  ...
  tabPanel("Frech Takes",
           ...
           h5(""),
           hr(),
           tags$li("David has a 2-game lead, the undisputed best team per FVOA, and is essentially a lock to make the playoffs. He's also #1 in SOR and Colley, so good luck to anyone else in the playoffs as of now"),
           tags$li("PFinn's disappointing game has dropped him to 3rd weakest team now that games are getting more weight as we get deeper into the season"),
           tags$li("Glad to see Justin has a new underrated friend with Bobby joining him in that quadrant now"),
           tags$li("Don't sleep on Chris's team - he's somehow got the 2nd strongest team despite being in 8th and with PF of a roughly average team. FVOA seems to like his trend and is willing to buy low and go for a ride to end of season. If FanDuel took our bets this is the optimal pick if you want value."),
           tags$li("This has been a pretty volatile season with Josh's team somehow in 5th place despite being 2nd weakest with outside chance of making playoffs and more likely coming in 9th"),
           tags$li("I couldn't figure out why my team sitting in 4th with 5th best team had 2nd best chances of making playoffs until I saw I have the easiest remaining schedule according to FVOA"),
           tags$li(HTML("<u><strong>Commish Corner</strong></u> - <1% still counts, right?
                        ")),
           hr(),
