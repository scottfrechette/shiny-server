...
ui  <- navbarPage(
  ...
  tabPanel("Frech Takes",
           ...
           h5(""),
           hr(),
           tags$li("And just like that 3 more teams have failed to make the playoffs. Bobby has the toughest beat given the 4th strongest team doesn't even have a shot in final week."),
           tags$li("This also means we have two matchups with no playoff impacts whatsoever (David vs Commish and Bobby vs Josh"),
           tags$li("Here's what each of the four contenders for final two spots need to make it:"),
           tags$ol(
             tags$li("If PFinn wins, he's in. If he loses he needs Eric to lose or the winner of Chris vs me to not make up the point-deficit (87% chance to make it)."),
             tags$li("Eric's path is entirely in his control - it's either win and make it or lose and miss out (68% chance to make it)"),
             tags$li("Chris needs to win and Eric lose or PFinn lose and he makes up the 20-point deficit (29% chance to make it)"),
             tags$li("I need to win and Eric lose or PFinn lose and I make up the 52-point deficit (16% chance to make it)")),
           tags$li("Based on FVOA the best four teams possible at this point would be: David (1st), Diaz (5th), Eric (2nd), and Chris (3rd)"),
           tags$li("It's worth pointing out at this point David is a 2-TD favorite over average team and Commish is 2-TD underdog. David's team is so strong he'd be a TD favorite over Eric's 2nd strongest team."),
           tags$li(HTML("<u><strong>Commish Corner</strong></u> - I don't remember who picked up your chaos players, but curious to know if you impacted the final results here")),
           hr(),
