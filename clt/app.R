...
ui  <- navbarPage(
  ...
  tabPanel("Frech Takes",
           ...
           h5(""),
           hr(),
           tags$li("We're starting to see the rankings match reality for most part with four strongest teams ranked in top-4 for now, and in fact they're the only teams to be favored against a historically-average team"),
           tags$li("Eric has biggest reason to gripe because he's still winless yet in most randomized schedules he'd be closer to middle of pack"),
           tags$li("That said every team still has a chance, and that's not factoring in all the injuries we saw last week and bye weeks that'll start soon to bring some mid-season chaos into the mix"),
           tags$li("Justin has the only team that has been above-average all 3 weeks so far, which is why he is top-ranked team by FVOA and best odds of making playoffs"),
           # tags$ul(tags$li("")),
           tags$li(HTML("<u><strong>Commish Corner</strong></u> - looks like you are who FVOA said you are")),
           hr(),
