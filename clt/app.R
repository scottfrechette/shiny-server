...
ui  <- navbarPage(
  ...
  tabPanel("Frech Takes",
           ...
           h5(""),
           hr(),
           tags$li("With 3 weeks still left to play in regular season it's happened, the first tribute has fallen. Let's honor the memory of Eric, who was eliminated early because there are 3 teams weaker than he."),
           tags$li("It will be an interesting week because the 4 teams tied for 2nd are all playing each other, so let chaos reign"),
           tags$li("Huge win for FVOA as PFinn's loss dropped him from 2nd to 5th, but that's still wildly out of step given he has the weakest team and would be in last place in 58% of randomly simulated schedules. Which of course means he'll beat me this week and reclaim his playoff spot."),
           tags$li("Another big win for German hasn't done much to get the 4th strongest team any closer to playoffs, though there's still a <1% chance he pulls off an insane upset from 9th place. Bama had 99.9% chance of losing with 43 seconds left so I guess Roll German?"),
           tags$li("No one sleep on David's team that's quietly surging and is only 1 win from sneaking into top-4"),
           tags$li("Actually Josh's team would also land top-4 with win over David because of how close everyone is and the 4 teams tied for 2nd all playing each other"),
           tags$li(HTML("<u><strong>Commish Corner</strong></u> - there's still a 1-in-20 chance Barrett pulls of a huge upset to make the playoffs if he is able to take out the good bad German team")),
           hr(),
