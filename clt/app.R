...
ui  <- navbarPage(
  ...
  tabPanel("Frech Takes",
           ...
           h5(""),
           hr(),
           tags$li("The league just suddenly got boring where the top 4 teams are the four best, and then 5 and 6 are perfectly ranked according to FVOA"),
           tags$li("Really the only chaos is PFinn is 7th best team but is somehow the final winless team"),
           tags$li("It's a lot of fun to see that FVOA is really not trusting my team and thinks I've gotten pretty lucky so far"),
           tags$li("I was confused why Bobby's team has lowest chances of making playoffs, but I guess it's only because Barrett's team has a slightly easier schedule"),
